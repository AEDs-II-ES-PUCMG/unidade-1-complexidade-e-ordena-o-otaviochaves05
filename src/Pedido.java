...
public class Pedido implements Comparable<Pedido>{
	...
	public double valorFinal() {
		...
		for (ItemDePedido itemDePedido : itens) {
			valorPedido += itemDePedido.getPrecoVenda() * itemDePedido.getQuantidade();
		}
		return valorPedido;
    ...
    public double indiceEconomia() {
        return 0d;//Sua lógica de cálculo do índice de economia aqui
    }
	...
	public double getTicketMedio() {
		return valorFinal() / (double) quantItens;
	}
}
